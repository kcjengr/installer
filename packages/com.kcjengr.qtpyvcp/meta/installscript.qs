...
Component.prototype.createOperations = function()
{
    ...
    component.addOperation("Execute", "python", "-m", "pip", "install", "--user", "--upgrade", "qtpyvcp-@ProductVersion@-py2-none-any.whl", "UNDOEXECUTE", "python", "-m", "pip", "uninstall", "--yes", "qtpyvcp");
}
