...
qtpyvcp.commands += $$(HOME)/Qt/QtIFW-4.0.0/bin/binarycreator -p $$PWD/packages --config $$PWD/config/config.xml $$PWD/bin/${QMAKE_FILE_OUT};
qtpyvcp.commands += $$(HOME)/Qt/QtIFW-4.0.0/bin/repogen -p $$PWD/packages -i com.kcjengr.qtpyvcp --update $$PWD/repo;
